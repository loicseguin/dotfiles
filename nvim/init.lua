...
require('lazy').setup({
    ...
    'nvim-tree/nvim-web-devicons',  -- For nice icons in status line
    {  -- LSP plugins
...
vim.keymap.set('n', '<leader>ve', ':e $MYVIMRC<CR>', { desc = 'Edit vimrc', silent = true })
vim.keymap.set('n', '<leader>vs', ':so $MYVIMRC<CR>', { desc = 'Reload vimrc', silent = true })
